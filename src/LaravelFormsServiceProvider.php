...
class LaravelFormsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../resources/lang', 'laravel-forms');
        ...
        if ($this->app->runningInConsole()) {
            ...
            // Publishing assets.
            /*$this->publishes([
                __DIR__.'/../resources/assets' => public_path('vendor/laravel-forms'),
            ], 'assets');*/

            // Publishing the translation files.
            /*$this->publishes([
                __DIR__.'/../resources/lang' => resource_path('lang/vendor/laravel-forms'),
            ], 'lang');*/
